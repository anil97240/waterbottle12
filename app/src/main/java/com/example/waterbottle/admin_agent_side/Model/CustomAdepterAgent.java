...
public class CustomAdepterAgent extends BaseExpandableListAdapter {
    ...
    public CustomAdepterAgent(Context context, List<String> headerItem, HashMap<String, List<String>> childItem) {
